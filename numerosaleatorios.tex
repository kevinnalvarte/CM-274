...
\IEEEauthorblockA{\\{*}Castillo Flores Junior Manuel,Nalvarte Yantas Kevin Jeffry }\\
\centerline{\textit{Facultad de Ciencias, Universidad Nacional de Ingenier\'ia}}\\
\centerline{\textit{Lima-Per\'u}}\\


\author{\IEEEauthorblockN{\IEEEauthorblockA{\textbf{juniorcastillon6$@$gmail.com,kevinnalvarte$@$hotmail.com}}}}
}
\maketitle
\begin{abstract}
%%aqui va el abstract
